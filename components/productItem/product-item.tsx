...
const Productitem: React.FC<Product & { category: Partial<Category> }> = ({
  ...
  return (
    <Link
      ...
      className="col-span-2 w-full border cursor-pointer rounded-2xl group hover:shadow-lg overflow-hidden"
    >
      <div>
        ...
        <div className="p-6">
          ...
          <p className="font-extrabold text-md hover:underline transition-all duration-300">
            {title}
          </p>
